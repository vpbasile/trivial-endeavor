...
import { category, phaseDefinition, fixMeLater, categoryTag, player, question, choices, whatsHappening } from "../dataStructures";
...
type QuestionProps = {
	...
	guessedState: boolean;
	setGuessedState: fixMeLater;
	// <><><> Winning
	winners: fixMeLater;
